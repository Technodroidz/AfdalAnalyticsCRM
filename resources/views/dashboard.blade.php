                              ...
                              <div class="col-lg-3 col-sm-12 col-12">
                                 <div class="row">
                                    <div class="col-lg-12 col-sm-3 col-12">
                                       <div class="card mb-4">
                                          <div class="card-body text-right">
                                             <h5 class="font-weight-bold">Total Page Reach</h5>
                                             <div class="d-flex-dashbard-data mt-3">
                                                <div class="dashboard-data-2 text-right">
                                                   <h3 class="font-weight-bold m-0">11M</h3>
                                                </div>
                                    ...
                                    <div class="col-lg-12 col-sm-3 col-12">
                                       <div class="card mb-4">
                                          <div class="card-body text-right">
                                             ...
                                             <div class="d-flex-dashbard-data mt-3">
                                                <div class="dashboard-data-2 text-right">
                                                   <h3 class="font-weight-bold m-0">8,982</h3>
                                                </div>
                                    ...
                                    <div class="col-lg-12 col-sm-3 col-12">
                                       <div class="card mb-4">
                                          <div class="card-body text-right">
                                             <h5 class="font-weight-bold">Total Page Likes</h5>
                                             <div class="d-flex-dashbard-data mt-3">
                                                <div class="dashboard-data-2 text-right">
                                    ...
                                    <div class="col-lg-12 col-sm-3 col-12">
                                       <div class="card mb-4">
                                          <div class="card-body text-right">
                                             <h5 class="font-weight-bold">Total Page Acions</h5>
                                             <div class="d-flex-dashbard-data mt-3">
                                                <div class="dashboard-data-2 text-right">
                                                   <h3 class="font-weight-bold m-0">234</h3>
                                                </div>
                              ...
                              <div class="col-lg-9 col-sm-12 col-12">
                                 <div class="row">
                                    <div class="col-lg-6 col-sm-6 col-12">
                                       <div class="card mb-3">
                                          <div class="card-body">
                                             <h5 class="font-weight-bold text-right">Daily Page Reach</h5>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-12">
                                       <div class="card mb-3">
                                          <div class="card-body">
                                             <h5 class="font-weight-bold text-right">Followers by Gender</h5>
                                             <div id="chart2"></div>
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-12">
                                       <div class="card mb-3">
                                          <div class="card-body">
                                             <h5 class="font-weight-bold text-right">Daily Page Likes</h5>
                                             <div id="chart"></div>
                                             <div class="bottom-charts">
                                                <ul class="text-right">
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-12">
                                       <div class="card mb-3">
                                          <div class="card-body">
                                             <h5 class="font-weight-bold text-right">Follower By Country</h5>
                                             <div id="chartdiv"></div>
                                             <div class="bottom-charts">
                                                <ul class="text-right">
